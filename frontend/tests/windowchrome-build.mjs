...
if(mutation&&!['small-corners','flow-notice','clipped-frame','duplicate-header'].includes(mutation))throw new Error('Unknown mutation')
const plugins=mutation?[{name:mutation,setup(build){build.onLoad({filter:/styles\.css$/},({path:file})=>{
