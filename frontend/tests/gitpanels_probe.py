...
def run():
    ...
    try:
        with sync_playwright() as p:
            ...
            child.wait_for_function('document.querySelectorAll(".git-loading").length===0')
            ...
            extra.locator('.git-node').first.wait_for()
