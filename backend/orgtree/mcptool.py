...
TOOLS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "gpt-reserve ALSO needs that sign-in to be a ChatGPT subscription, "
            "not an API key, since reserve capacity is a subscription perk — "
            "it is intermittent for that reason even while Codex itself stays "
            "connected); "
