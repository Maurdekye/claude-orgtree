# Historical feature docket

> This is a feature-request record, not a current product specification. For
> current behavior, start at [the documentation map](../README.md).
